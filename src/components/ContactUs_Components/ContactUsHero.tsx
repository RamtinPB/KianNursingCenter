...
export default function ContactUsHero() {
  return (
    <>
      <div className="relative flex flex-col items-center justify-center px-6 dark:bg-gray-900">
        <div className="absolute inset-0 bg-[url('/assets/Black_Desk1.jpg')] bg-cover bg-top bg-no-repeat blur-md" />
